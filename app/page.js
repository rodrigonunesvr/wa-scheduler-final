                ...
                <div className="p-8 space-y-6">
                    ...
                    <div className="flex flex-col gap-3 pt-4">
                        <div className="grid grid-cols-2 gap-3">
                            <a href={whatsappLink(apt.customer_phone, `Olá ${apt.customer_name}, tudo bem? Passando para lembrar e confirmar o seu agendamento de ${svcs.join(' + ')}, dia ${new Date(apt.starts_at).toLocaleDateString('pt-BR', { day: '2-digit', month: '2-digit', timeZone: 'America/Sao_Paulo' })} às ${toSPTime(apt.starts_at)}. Podemos confirmar?`)} target="_blank" rel="noopener" className="py-4 rounded-3xl bg-[#25D366] text-white font-black text-[10px] uppercase tracking-widest text-center shadow-xl shadow-green-500/20 hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-2">
                                <MessageCircle size={16} /> Lembrar / Confirmar
                            </a>
                            <a href={whatsappLink(apt.customer_phone)} target="_blank" rel="noopener" className="py-4 rounded-3xl glass text-white font-black text-[10px] uppercase tracking-widest text-center border border-white/10 hover:bg-white/10 transition-all flex items-center justify-center gap-2">
