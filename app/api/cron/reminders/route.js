    ...
    try {
        ...
        for (const apt of appointments) {
            try {
                ...
                const message = `OlÃ¡ ${apt.customer_name}! Passando para lembrar do seu agendamento amanhÃ£, dia ${moment(tomorrow).format('DD/MM')}, Ã s ${timeStr}. âœ¨ Nos vemos em breve!`;
